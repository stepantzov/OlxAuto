...
import testResultsRepoting.LoggerReportCreator;
import testResultsRepoting.PrintStreamReportAdapter;
...
public class MainSuiteBuilder extends TestConditions {
    ...
    public void highPriorityTestSuiteBuilder() {
        ...
        System.out.println("Total test cases executed count: " +
                coreFunctionalitySuite.testSuiteTestCasesCount());
    ...
    public void lowPriorityTestSuiteBuilder() {
        ...
        /*
        Example of adapter usage below.
        */
        LoggerReportCreator loggerReportCreator = new LoggerReportCreator();
        PrintStreamReportAdapter printStreamReportAdapter = new PrintStreamReportAdapter(loggerReportCreator);

        try {
            printStreamReportAdapter.richTextOutput();
